function conditionalFormattingKodeBahan() {
    ...
    const formatRules = [
        ...
        { value: 11, background: "#aba9a9", fontColor: "black" },
        { value: 9, background: "#aba23c", fontColor: "black" },
        { value: 0, background: "#b2e0eb", fontColor: "black" },
        { value: 7, background: "#4642b8", fontColor: "black" },
        { value: 5, background: "#f8fa89", fontColor: "black" },
        { value: 3, background: "red", fontColor: "black" },
        { value: 1, background: "#41c42d", fontColor: "black" },
    ];
...
function conditionalFormatting_notEmpty() {
    const columns = [
...
conditionalFormatting_notEmpty();
